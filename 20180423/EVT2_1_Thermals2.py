...
filename_zone = "04_Sleep_USBin_NotCharging_Front.csv"    
filename_flir = "20180423Flir - 04_Sleep_USBin_Notcharging.csv"
title = 'Sleep, USB In, Not Charging, Front'
...
plt.scatter(dates2desired,point5desired,label="Spot6",color="m")
...
plt.annotate('%0.2f' % point1desired[-1], xy=(1,point1desired[-1]), xytext=(0, 16), 
...
plt.annotate('%0.2f' % point5desired[-1], xy=(1,point5desired[-1]), xytext=(0, -20), 
                 xycoords=('axes fraction', 'data'), textcoords='offset points',color="c")
plt.annotate('%0.2f' % point6desired[-1], xy=(1,point5desired[-1]), xytext=(0, -30), 
