...
filename_zone = "20180507/01_H21_2D0.csv"    
filename_flir = "20180507/20180507 - 01_H21_2D0.csv"
title = 'H39, Thermal-engine off, 2D0'
...
for line in content:
    ...
    zone11_list.append(float(splt[8]))
#    temp_3d_list.append(float(splt[11]))


zone11_list2 = [i / 10 for i in zone11_list]
...
plt.scatter(dates, zone11_list2, label="Zone11-tsens_tz_sensor0", color="y")
plt.annotate('%0.2f' % zone11_list2[-1], xy=(1,zone11_list2[-1]), xytext=(0, -10), 
                 xycoords=('axes fraction', 'data'), textcoords='offset points',color="y")
...
plt.scatter(dates2desired,point9desired,label="Spot9",color="g",marker="*")
plt.scatter(dates2desired,point10desired,label="Spot10",color="k",marker="*")
...
#plt.ylim(0,(max(temp_3d_list)+10))
#plt.ylim(0,(max(zone9_list)+10))
plt.ylim(0,(max(zone11_list2)+10))
#plt.ylim(0,(max(point2)+10))
print(max(point1))
plt.legend(loc='lower right', frameon=True)



plt.annotate('%0.2f' % point1desired[-1], xy=(1,point1desired[-1]), xytext=(0, 20), 
                 xycoords=('axes fraction', 'data'), textcoords='offset points',color="b")
plt.annotate('%0.2f' % point2desired[-1], xy=(1,point2desired[-1]), xytext=(0, 18), 
                 xycoords=('axes fraction', 'data'), textcoords='offset points',color="r")
plt.annotate('%0.2f' % point3desired[-1], xy=(1,point3desired[-1]), xytext=(0, 5), 
...
plt.annotate('%0.2f' % point5desired[-1], xy=(1,point5desired[-1]), xytext=(0, 12), 
                 xycoords=('axes fraction', 'data'), textcoords='offset points',color="c")
plt.annotate('%0.2f' % point6desired[-1], xy=(1,point6desired[-1]), xytext=(0, 3), 
                 xycoords=('axes fraction', 'data'), textcoords='offset points',color="m")
plt.annotate('%0.2f' % point7desired[-1], xy=(1,point7desired[-1]), xytext=(0, -35), 
                 xycoords=('axes fraction', 'data'), textcoords='offset points',color="b")
plt.annotate('%0.2f' % point8desired[-1], xy=(1,point8desired[-1]), xytext=(0, -18), 
                 xycoords=('axes fraction', 'data'), textcoords='offset points',color="r")
plt.annotate('%0.2f' % point9desired[-1], xy=(1,point9desired[-1]), xytext=(0, -25), 
                 xycoords=('axes fraction', 'data'), textcoords='offset points',color="g")
plt.annotate('%0.2f' % point10desired[-1], xy=(1,point10desired[-1]), xytext=(0, -50), 
                 xycoords=('axes fraction', 'data'), textcoords='offset points',color="k")
plt.show()
